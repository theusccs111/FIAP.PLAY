...
namespace FIAP.PLAY.Domain.UserAccess.Entities
{
    public class User : EntityBase
    {
        ...
        private User(string name, string passwordHash, Email email, ERole role, bool active)
        {
            Name = name;
        ...
        public static User Criar(string name, string passwordHash, string emailstr, ERole role, bool active)
        {
            ...
            var email = Email.Criar(emailstr);
